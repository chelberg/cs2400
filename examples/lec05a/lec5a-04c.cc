...
// last-modified: Tue Feb  5 07:23:38 2019
// 
...
int main()
{
  ...
  do {
	...
	cout << "ERROR! We should never get here!\a\n";
      }
    } while ((guess != number) && (count < MAX_GUESSES));

    if ((guess != number) && (count == MAX_GUESSES)) {
      cout << "You are out of guesses, therefore you lose, my number was: " << number << end
    }
